...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "programs.card1.title": {
    en: "Skill Advancement Workshops",
    zh: "技能进阶工作坊",
  },
  "programs.card1.desc": {
  ...
  "programs.card2.title": {
    en: "Engage with Industry Leaders",
    zh: "对话行业领袖",
  },
  "programs.card2.desc": {
  ...
  "programs.card3.title": {
    en: "Build an Exclusive Community",
    zh: "构建精英社群",
  },
  "programs.card3.desc": {
...
export function LangProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    try {
      stored = localStorage.getItem("rucfc-lang") as Lang | null;
    } catch {}
