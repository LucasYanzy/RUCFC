...
export default function Discord() {
  ...
  const tiltRef = useInteractiveTilt({ maxTilt: 2.4, scale: 1.014, gyroTilt: 1.2 });
        ...
        <div className="discord-wrapper reveal">
          ...
          <div className="discord-info">
            ...
            <div className="discord-features">
              <div
                className={`discord-feature ${activeTab === "chat" ? "active" : ""}`}
              ...
              <div
                className={`discord-feature ${activeTab === "signals" ? "active" : ""}`}
            ...
            >
              ...
              <span className="btn-label">{t("discord.join")}</span>
          ...
          <div className="discord-preview">
            <div className="discord-mockup-wrapper interactive-tilt" ref={tiltRef}>
